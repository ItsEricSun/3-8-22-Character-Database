...
public class GUI extends GBFrame {
	...
	JButton insert1Button, insert2Button;
	...
	public void insert1() {
		JLabel label = addLabel("Enter first character:", 1,1,2,1);
	...
	public void insert2() {
		...
		frm.setSize(500, 500);
		frm.repaint();
		JLabel label = addLabel("Enter second character:", 1,1,2,1);
		JLabel nameLabel = addLabel("Name", 2,1,1,1);
		nameField = addTextField("", 2,2,1,1);
		JLabel roleLabel = addLabel("Class", 3,1,1,1);
		roleField = addTextField("", 3,2,1,1);
	...
	public void buttonClicked(JButton buttonObj) {
		if(buttonObj == insert1Button) {
			...
			if(name.equals("")) {
				...
				messageBox("Error: Please Eneter Level");
				return;
